...
{
    /// <inheritdoc />
    public partial class AddAiData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AiConversations_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageRole = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AiMessages_Users_AuthorUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiConversations_OrderId",
                table: "AiConversations",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_AiMessages_AuthorUserId",
                table: "AiMessages",
                column: "AuthorUserId");
